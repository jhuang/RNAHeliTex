...
The topic of my project is helices index of RNAs
If you have some questions during my presentation, feel free to interrupt me.

2. slide
I've divided my presentation into 4 parts
- in the first part, I will give an overview of secondary structure domains and classical algorithms
- because the concept of helices indices of RNAs is based on the concept of abstract shapes, so I will introduce the concept of abstract shapes in the 2nd part.
- give some ideas about development of a new structure abstraction.
In this part, I will also point out one serious problem we might [probably] encounter
