...
\frametitle{Outlook}
    ...
    \item implement a software with the ADP framework in C++ programming language based on the idea
    \item evaluate the algorithm comparing with other programs
    \item design a RNA class predictors
    \end{itemize}
\end{frame}
